...
public class AdminUserSearch2 {
        ...
        public void searchByUsername() throws Exception {
            ...
            if (expectedText.equals(actualText))
            {
                ...
                takeSnapShot(driver, "C:\\Users\\Dell\\Desktop\\New folder\\SearchByUsernameSuccess.png");
            }
            else
            {
                System.out.println("TC 001: FAIL");
                System.out.println("TC 001: Screen Image Captured - Fail");
                takeSnapShot(driver, "C:\\Users\\Dell\\Desktop\\New folder\\SearchByUsernameError.png");
        ...
        public void searchByNonExistingUsername() throws Exception {
            ...
            else
            {
                ...
                takeSnapShot(driver, "C:\\Users\\Dell\\Desktop\\New folder\\SearchByNonExistingUsernameError.png");
            }
            System.out.println("------------------------------------");
        ...
        //Reset Search Filter And Results (TC: 006)
        @Test (priority = 6)
        ...
        public void employeeNameEnter() throws InterruptedException {
            //enter employee name
            driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div[1]/div[2]/form/div[1]/div/div[3]/div/div[2]/div/div/input")).sendKeys("manda user");
